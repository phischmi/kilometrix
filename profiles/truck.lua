-- truck.lua — LKW-Profil für OSRM, abgeleitet von car.lua (osrm-backend v26.6.5).
-- Anpassungen ggü. car.lua: Maße/Gewicht (4.0 m / 2.55 m / 16.5 m / 40 t),
--   hgv-Zugang (access_tags_hierarchy + restrictions), LKW-Geschwindigkeiten,
--   vehicle_max_speed = 89.
-- WICHTIG: muss im selben Verzeichnis wie das mitgelieferte car.lua liegen,
--   weil es `require "lib/..."` nutzt. Startprofil — vor Produktiveinsatz an
--   echten Routen prüfen (Maße/Gewicht je nach Flotte anpassen).
...
function setup()
  return {
    ...
    vehicle_height = 4.0, -- LKW: gesetzl. Maximalhoehe DE 4.0 m
    vehicle_width = 2.55, -- LKW: 2.55 m

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 16.5, -- LKW: Sattelzug 16.5 m
    vehicle_weight = 40000, -- LKW: 40 t
    ...
    vehicle_max_speed = 89, -- LKW: ~89 km/h Begrenzung
